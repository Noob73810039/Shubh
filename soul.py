...
TOKEN = '7244934052:AAH0AuXy-YEUSYKTdRvMkwHVYUSgVz6-sgM'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002461081674
CHANNEL_ID = -1002461081674
error_channel_id = -1002461081674
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/+PmHqi1TNCKkxYzk1*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@ITS_BFC*", parse_mode='Markdown')
    else:
